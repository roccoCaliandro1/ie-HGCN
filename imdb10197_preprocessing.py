...
def load_imdb3228(train_percent):
	...
	dataset='imdb10197'
	movie_feature_path = os.path.join(current_dir, 'imbd10197_dataset', dataset+'_movie_feature.pkl')
	...
	with open(movie_feature_path, 'rb') as in_file:
		m_ft = pickle.load(in_file)

	adjacency_matrices_path = os.path.join(current_dir, 'imbd10197_dataset', dataset+'_sp_adj_mats.pkl')
	# load the adjacency matrices, created during the preprocessing phase
	with open(adjacency_matrices_path, 'rb') as in_file:
	...
	hgcn_path = os.path.join(current_dir, 'imbd10197_dataset', 'imbd10197_hgcn_'+str(train_percent)+'.pkl')
