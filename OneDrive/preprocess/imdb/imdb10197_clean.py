...
# m_raw_id_feature = np.genfromtxt('./cleaned/movie.txt', delimiter='\t', missing_values='\\N', filling_values=0.0, dtype=np.float32)
...
# m_a = np.genfromtxt('./cleaned/movie_actor.txt', delimiter='\t', dtype=np.str)
...
# m_c = np.genfromtxt('./cleaned/movie_country.txt', delimiter='\t', dtype=np.str)
...
# m_d = np.genfromtxt('./cleaned/movie_director.txt', delimiter='\t', dtype=np.str)
...
# m_t = np.genfromtxt('./cleaned/movie_tag.txt', delimiter='\t', dtype=np.int32)
...
# m_u = np.genfromtxt('./cleaned/movie_user.txt', delimiter='\t', dtype=np.float32)
...
# m_g = np.genfromtxt('./cleaned/movie_genre.txt', delimiter='\t', dtype=np.str)
